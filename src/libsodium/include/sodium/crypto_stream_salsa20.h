...
SODIUM_EXPORT
int crypto_stream_salsa20(unsigned char *,uint64_t,const unsigned char *,const unsigned char *);

SODIUM_EXPORT
int crypto_stream_salsa20_xor(unsigned char *,const unsigned char *,uint64_t,const unsigned char *,const unsigned char *);
